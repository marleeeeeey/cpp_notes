...
- [Native commands (main debug commands)](#native-commands-main-debug-commands)
  ...
  - [31. `t`, `p`, `.logopen` - Time Travel Debugging](#31-t-p-logopen---time-travel-debugging)
    ...
    - [Command `wt` - Walk Trace](#command-wt---walk-trace)
...
#### Command `wt` - Walk Trace

- Используется для анализа выполненных инструкций после трассировки программы. Команда показывает:
  - Список функций, вызванных программой.
  - Количество инструкций, выполненных в каждой функции.
  - Сводку по вызовам системных функций и потокам.
