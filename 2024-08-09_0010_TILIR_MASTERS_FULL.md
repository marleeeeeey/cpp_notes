...
- [2. Шаблоны функций](#2-шаблоны-функций)
...
- [3.1 Шаблоны классов](#31-шаблоны-классов)
...
- [3.2 Шаблоны классов - Специализация методов классов](#32-шаблоны-классов---специализация-методов-классов)
...
- [3.3 Шаблоны классов - Вывод типов шаблонами классов](#33-шаблоны-классов---вывод-типов-шаблонами-классов)
...
- [3.4 Шаблоны классов - Разрешение имен](#34-шаблоны-классов---разрешение-имен)
...
- [4.1 Модули - One Definition Rule (ODR)](#41-модули---one-definition-rule-odr)
...
- [5. SFINAE (Substitution Failure Is Not An Error)](#5-sfinae-substitution-failure-is-not-an-error)
...
## 3.2 Шаблоны классов - Специализация методов классов
...
## 3.3 Шаблоны классов - Вывод типов шаблонами классов
...
## 3.4 Шаблоны классов - Разрешение имен
...
## 4.1 Модули - One Definition Rule (ODR)
