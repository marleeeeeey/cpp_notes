...
{
    talk_to_client() : sock_(service), already_read_(0) { last_ping = microsec_clock::local_time(); }
...
void handle_clients_thread()
{
    while (true)
    {
        ...
        clients.erase(
            std::remove_if(clients.begin(), clients.end(), boost::bind(&talk_to_client::timed_out, _1)), clients.end());
    }
}
