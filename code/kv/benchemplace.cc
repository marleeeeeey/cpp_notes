...
int main(int argc, char** argv)
{
    ...
    std::cout << "Linear fill with push: " << duration_cast<milliseconds>(tfin - tstart).count() << std::endl;
    ...
    std::cout << "Linear fill with emplace: " << duration_cast<milliseconds>(tfin - tstart).count() << std::endl;
