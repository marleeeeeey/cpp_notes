...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 13. Проектирование - 2021 [DONE]
  - https://www.youtube.com/watch?v=D6nn1PLJrzg
    ...
    - 00:11:06 UML
    - 00:19:20 SOLID
    - 00:22:50 Единственная ответственность
    - 00:30:55 Связность
    - 00:35:40 Принцип открытости и закрытости
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 18. Определители типов и SFINAE - 2022 [DONE]
  - https://www.youtube.com/watch?v=KZ24E8pWNwg&t
    ...
    - 00:38:01 Списки инициализации
    - 00:44:16 Проблема конструирования из пары итераторов
    - 00:49:43 SFINAE
    - 00:55:50 Интегральные константы и определители типов
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 19. Вариабельные шаблоны - 2022 [DONE]
  - https://www.youtube.com/watch?v=JC8yVbvDxyg
    ...
    - 00:22:20 Emplace
    - 00:29:24 Шаблонные методы и ООП
    - 00:36:10 void_t и проверка существования
    - 00:46:03 declval и настоящее решение
    - 00:56:10 Свёртки
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 20. Итераторы - 2022 [DONE]
  - https://www.youtube.com/watch?v=avnte_HqBKQ&t
    ...
    - 00:27:20 Изобретаем enable_if
    - 00:36:00 Итераторы и не итераторы
    - 00:42:40 Объединяем пару диапазонов
    - 00:58:33 Константные и обратные итераторы
    - 01:06:55 Трюки Майерса и Хиннанта
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 22. LLVM, часть 1 - 2022 [TODO] [SKIPPED]
  - https://www.youtube.com/watch?v=yEdoXnEaMrw
    ...
    - 00:30:45 getelementptr
    - 00:41:25 Иерархия классов в LLVM
    - 00:51:40 ParaCL и компиляция
    - 01:00:15 Кодогенерация
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 22. LLVM, часть 2 - 2022 [TODO] [SKIPPED]
  - https://www.youtube.com/watch?v=rLshTsxgDcw
    ...
    - 00:23:40 Файловая система
    - 00:31:10 Итераторы перемещения
    - 00:39:27 Возвращаемся к LLVM: IRBuilder
    - 00:50:05 RTTI в стиле LLVM
    - 00:58:45 Оптимизации
...
- Konstantin Vladimirov - Базовый курс C++ (MIPT, ILab). Lecture 23. Последовательные контейнеры - 2022 [TODO]
  - https://www.youtube.com/watch?v=zEP7KRc2t3k
    ...
    - 00:10:50 Списки
    - 00:21:40 Адаптеры
    - 00:25:40 Case study: алгоритм Прима
    - 00:34:55 Ортогональность адаптеров
    - 00:41:30 Маски
    - 00:47:55 Строки
    - 01:04:05 string_view и span
...
- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 03. Шаблоны классов и частичная специализация - 2022 [DONE]
  - https://www.youtube.com/watch?v=e4NpXk9l51w
    ...
    - 00:16:20 Чья специализация?
    - 00:21:40 Имена в шаблонах
    - 00:33:42 Частичная специализация
    - 00:43:55 Трюк Саттера
...
- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 06. SFINAE - 2022  [DONE]
  - https://www.youtube.com/watch?v=XGbpmSCEK0s
    - 00:00:00 Семантические процессы
    - 00:02:40 Глобальный фрагмент и инстанцирование
    - 00:16:30 Ленивость
    - 00:28:10 Провал подстановки и ошибки
    - 00:40:30 Партизанское SFINAE
    - 00:51:00 Отображения
...
- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 07. Классическое метапрограммирование - 2022  [DONE]
  - https://www.youtube.com/watch?v=jL3CNQr-0Cg
    - 00:00:00 Введение
    - 00:03:30 Проблемы void_t
    - 00:11:10 Трюк Хаггинса
    - 00:16:45 Условные типы
    - 00:31:15 One-off function и её уроки
    - 00:41:05 Трамплинное SFINAE
    - 00:52:15 Классическое метапрограммирование
    - 01:03:45 Loki и MPL
    - 01:16:10 Fusion
    - 01:27:05 Литература

- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 08. Константные выражения - 2022  [DONE]
  - https://www.youtube.com/watch?v=jyYys1UcHkM
    - 00:00:00 Константность
    - 00:10:18 Плавающая константность
    - 00:15:20 Systematic C++
    - 00:17:54 Переменные времени компиляции
    - 00:27:17 Constexpr control flow
    - 00:36:00 Функции времени компиляции
    - 00:43:55 Ограничения в C++14
    - 00:54:06 consteval и constinit
    - 01:11:40 Несколько примеров и завершение

- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 09. Волшебство времени компиляции - 2022  [DONE]
  - https://www.youtube.com/watch?v=NS-qY5P7xDc
    - 00:00:00 Константные выражения
    - 00:07:25 UB для constexpr
    - 00:13:45 ООП времени компиляции
    - 00:21:55 Constexpr evaluation
    - 00:27:42 Восточная сказка о виртуальных функциях
    - 00:36:28 Constexpr new
    - 00:46:10 Перегрузка кавычек
...
- Konstantin Vladimirov - Магистерский курс C++ (МФТИ, 2022-2023). Лекция 13. Лямбды - 2022  [TODO]
  - https://www.youtube.com/watch?v=j-UyAKux590
    - 00:00:00 Новый синтаксис и лямбды.
    - 00:06:00 Вызываемые объекты
    - 00:19:20 Обобщённые лямбды, концепты и явные аргументы
    - 00:27:10 Основы захвата и финальная прозрачная оболочка
    - 00:41:50 Вариабельные пачки и каррирование
    - 00:46:58 Главное правило захвата
    - 00:54:02 Проброс списка захвата и кортежи
